...
module.exports = { 
    SESSION_ID: process.env.SESSION_ID || 'kord_ai-bynTt0ZRLIbBfcjb',
    OWNER_NUMBER: process.env.OWNER_NUMBER || "212709620964",
    ...
    TIMEZONE: process.env.TIMEZONE || "Africa/Morocco",
    CAPTION: process.env.CAPTION || "",
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "Z4CK",
    STICKER_AUTHOR: process.env.STICKER_AUTHOR || "Z4CK",
